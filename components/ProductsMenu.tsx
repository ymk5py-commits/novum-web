...
function Item({ href, title, desc }: { href: string; title: string; desc: string }) {
  return (
    <a href={href} className="group block rounded-2xl px-3 py-2 transition-colors hover:bg-white/[0.05]">
      ...
      <div className="text-[12px] text-ivory-300/60">{desc}</div>
    </a>
  );
}
        ...
        {open && (
          ...
          >
            <div className="grid grid-cols-3 gap-4 rounded-3xl glass-strong p-5 shadow-glass-lg">
              ...
              {/* NOVUMed */}
              <div>
                <a href="/novumed" className="mb-2 flex items-center gap-1 px-3 font-mono text-[12px] uppercase tracking-ultrawide text-cobalt-300 hover:text-cobalt-100">
              ...
              {/* NOVUdent */}
              <div>
                <a href="/novudent" className="mb-2 flex items-center gap-1 px-3 font-mono text-[12px] uppercase tracking-ultrawide text-cobalt-300 hover:text-cobalt-100">
