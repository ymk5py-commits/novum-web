...
export const NOVUDENT: ProductConfig = {
  ...
  intro:
    "Todo lo que necesita una clínica dental en un solo lugar: odontograma por superficies, presupuestos con convenios y cuotas, caja, inventario, comisiones y reportes — con Botika, el agente de IA que confirma citas, encuesta y cobra por WhatsApp en tiempo real.",
  heroBullets: [
    "Odontograma interactivo por superficies (FDI)",
    "Presupuestos con convenios, cuotas y PDF",
    "Caja, gastos, morosidad y comisiones",
    "Botika: confirmación, NPS y cobranza por WhatsApp",
  ],
  problems: [
  ...
  modules: [
    { t: "Odontograma por superficies", d: "32 piezas FDI con morfología real: caries en mesial, corona en la 26 — queda auditado quién y cuándo." },
    { t: "Presupuestos y convenios", d: "Borrador → presentado → aceptado, descuento automático por convenio, cuotas e impresión en PDF." },
    { t: "Caja, gastos y morosidad", d: "Arqueo diario por método de pago, control de gastos y cuentas por cobrar con recordatorio en un clic." },
    { t: "Inventario", d: "Bodega virtual con stock mínimo, alertas de reposición y valorización." },
    { t: "Reportes y comisiones", d: "KPIs, tasa de aceptación, NPS de pacientes y pago a odontólogos calculado solo. Todo exportable a Excel." },
    { t: "Ortodoncia", d: "Aparatología, cuota mensual y línea de tiempo de controles." },
    { t: "Recetas y archivos", d: "Prescripciones con plantillas listas para imprimir, radiografías y fotos en la ficha." },
    { t: "Agenda + Botika (IA)", d: "Lista de espera, confirmación de citas, encuestas NPS y cobranza conversacional por WhatsApp — en tiempo real." },
  ],
  specialties: [
  ...
  faqs: [
    ...
    { q: "¿Migran mi clínica?", a: "Sí, y sin fricción: exportás tus pacientes desde tu software actual, copiás y pegás, y NOVUdent detecta las columnas solo — incluso carga la deuda pendiente de cada paciente en Cuentas por cobrar." },
